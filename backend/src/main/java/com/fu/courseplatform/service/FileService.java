...
public class FileService {
    @Value("${fucourse.upload-file.base-uri}")
    ...
    public void createDirectory(String folder) throws URISyntaxException {
        ...
        if(!tmpDir.isDirectory()) {
            try {
                ...
                System.out.println("Directory created, path = " + tmpDir.toPath());
            } catch (IOException e) {
                e.printStackTrace();
            }
        } else {
            System.out.println("Directory already exists, path = " + tmpDir.toPath());
        }
    }
